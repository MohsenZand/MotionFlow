...
# MODEL
flags.DEFINE_multi_integer('x_size', [3, 32, 32], 'model input')
flags.DEFINE_multi_integer('y_size', [32, 3, 32], 'model output')
...
flags.DEFINE_integer('num_mix', 3, '3 if input_channels == 1 else 10')
